...
export const getApplicationsCharts = (data, cancelToken) => async (dispatch, getState, { API_BOOK, toast, API }) => {

    let { GET_APPLICATION_CHARTS_API } = API_BOOK.APPLICATION
    ...
    if (response.status === 200) {
        ...
        dispatch({
            type: `UPDATE_APPLICATION_CHART_TAB_${tabNumber}`,
