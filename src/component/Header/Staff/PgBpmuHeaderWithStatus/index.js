...
const PgBPMUHeaderWithStatus = (props) => {
                ...
                <ul className={`${props.isDetailMode ? "d-none" : ''} list-unstyled custom-header-list`}>
                    ...
                    <li>
                        ...
                        <div>
                            <p>Recommended</p>
                            <p>
                                <strong>{props.applicationCount?.recommendedApplication}</strong>
                            </p>
                        </div>
                    </li>
                    <li>
...
export {PgBPMUHeaderWithStatus};

PgBPMUHeaderWithStatus.defaultProps={
    name : '',
    applicationCount:{},
    isDetailMode : false
}