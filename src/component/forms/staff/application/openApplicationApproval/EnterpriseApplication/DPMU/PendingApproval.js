...
class PendingApproval extends Component {
    ...
    onSubmit = () => {
        ...
        const { 
            ...
            smpuApprovalLetter,
            decmm,
            remarks, cancelToken } = this.props.applicationStatusDetail.egDmpuApplicationPending
    ...
    render() {
        ...
        let { egDmpuApplicationPending,egBmpuApplicationStatus } = this.props.applicationStatusDetail
                                    ...
                                    <ul className="p-0">
                                        ...
                                        <li>
                                            <p
                                                ...
                                                onClick={
                                                    () => openInNewTab(egDmpuApplicationPending, 'smpuApprovalLetter')
                                                }
                                            >
                                        ...
                                        <li>
                                            <p
                                                className="cursor-pointer"
                                                onClick={
                                                    () => openInNewTab(egDmpuApplicationPending, 'decmm')
                                                }
                                            >
                                                <img src={app} className="mr-2" />
