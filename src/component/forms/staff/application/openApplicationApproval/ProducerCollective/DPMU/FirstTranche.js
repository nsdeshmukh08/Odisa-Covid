                ...
                <Row className="approve-tab">
                    <Col className="score-tabs">
                        <div className="assesment-tab">
                            <FormInput
                                type="radio"
                                label="First Tranche Disbursement"
                                options={IS_TRUE}
                                name="isDisbursment"
                            ...
                            <Col md="11" className="p-0">
                                <Row>
                                    ...
                                    <Col xl="5" >
                                        <FormInput
                                            type="number"
                                            label="First Tranche Disbursement Amount"
                            ...
                            <Row className="p-3 mb-3 d-flex align-items-center">
                                <Col className="p-0">
                                    <p className="m-0">Complete all above data before Submit First Tranche</p>
                                </Col>
                                <Col md="auto">
                                    <Button 
                                        color={'primary'} 
