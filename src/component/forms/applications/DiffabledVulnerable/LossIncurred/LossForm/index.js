...
const LossForm = ({ iaLossIncurredDetails, ...rest }) => {
  let themeData = useContext(ThemeContext);
  console.log('++act', iaLossIncurredDetails);
  return (
    <Row className="form-body p-4 activity-form-main">
      <Col xl="7" lg="12" sm="12">
        ...
        <Row>
          <Col className="member-shg">
            <FormInput
              ...
              error={iaLossIncurredDetails['isLossIncurred']}
              value={iaLossIncurredDetails['isLossIncurred']}
            />
          </Col>
        </Row>
        ...
        <ActivityTable
          ...
          data={iaLossIncurredDetails.lossIncurredList}
          onChange={rest.onChange}
        />
      </Col>
    </Row>
