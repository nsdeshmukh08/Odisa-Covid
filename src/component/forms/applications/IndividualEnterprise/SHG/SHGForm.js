...
const SHGForm = ({ shgDetails, errors, onChange, onSubmit, ...rest }) => {
  ...
  let { shgMemberTypeData } = useSelector(
  ...
  return (
    <Row className="p-4 producer-detail row bg-white">
      <Col xl="8" lg="8" sm="12">
        ...
        <p className="small-size mt-3">{themeData.isShgMember}</p>
        <Row>
        ...
        { shgDetails.isShgMember === 0 && (
          <>
            <p className="small-size mt-3">{themeData.isHouseHoldMember}</p>
            <Row>
