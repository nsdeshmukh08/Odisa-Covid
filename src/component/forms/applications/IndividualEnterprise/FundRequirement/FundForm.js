        ...
        <Row>
          ...
          <Col lg="6" className="no-padding-input">
            <FormInput
              ...
              onChange={onChange}
              error={errors['bussinessActivities']}
              value={enterpriseDetails['bussinessActivities']}
          ...
          <Col lg="6" className="no-padding-input">
            <FormInput
              ...
              value={enterpriseDetails['machineries']}
              inputClassName="text-right"
            />
          </Col>
          <Col lg="6" className="align-self-center text-grey">
          ...
          <Col lg="6" className="no-padding-input">
            <FormInput
              ...
              value={enterpriseDetails['workingCapital']}
              inputClassName="text-right"
            />
          </Col>
          <Col lg="6" className="align-self-center text-grey">
          ...
          <Col lg="6" className="no-padding-input">
            <FormInput
              ...
              value={enterpriseDetails['purchaseServices']}
              inputClassName="text-right"
            />
          </Col>
          <Col lg="6" className="align-self-center text-grey">
          ...
          <Col lg="6" className="no-padding-input">
            <FormInput
              ...
              value={enterpriseDetails['marketLinkageSupport']}
              inputClassName="text-right"
            />
          </Col>
          <Col lg="6" className="align-self-center text-grey">
          ...
          <Col lg="6" className="no-padding-input">
            <FormInput
              ...
              value={enterpriseDetails['organizingAwarenessCamps']}
              inputClassName="text-right"
            />
          </Col>
          <Col lg="6" className="align-self-center text-grey">
          ...
          <Col lg="6" className="no-padding-input">
            <FormInput
              ...
              value={enterpriseDetails['infrastructure']}
              inputClassName="text-right"
            />
          </Col>
          <Col lg="6" className="align-self-center text-grey">
          ...
          <Col lg="6" className="align-self-center text-grey">
            <FormInput
              ...
              value={enterpriseDetails['otherCost']}
            />
          </Col>
        </Row>
      </Col>
