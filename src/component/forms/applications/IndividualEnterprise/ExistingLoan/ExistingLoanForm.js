...
const ExistingLoanForm = ({ ieExistingLoan, errors, ...props }) => {
  //console.log(ieExistingLoan, 'iaExistingLoan------------------------');
      ...
      <Row className="mb-4 py-3">
        ...
        <Col md="12">
          <FormInput
            ...
            options={IS_TRUE}
            onChange={onChange}
            value={ieExistingLoan.isExistingLoan}
          />
        </Col>
      </Row>
      {ieExistingLoan.isExistingLoan === true ? (
        <Row className="form-body activity-form-main">
          <Col xl="12" lg="12" sm="12" className="p-0 pr-4">
            <div className="activity-list">
              ...
              {ieExistingLoan.existingLoanList.map((data, index) => (
                <Row className="custom-select-head no-gutters">
                  ...
                  {ieExistingLoan.existingLoanList.length > 1 ? (
                    <img
