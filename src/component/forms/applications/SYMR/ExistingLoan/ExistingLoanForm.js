...
const ExistingLoanForm = ({ symrExistingLoan, errors, basicDetails = {}, ...props }) => {

    // console.log(symrExistingLoan, 'symrExistingLoan')
            ...
            <Row className="mb-4 py-3">
                ...
                <Col md="12">
                    <FormInput
                        ...
                        value={symrExistingLoan.isExistingLoan}
                    />
                </Col>
            </Row>
            {
                symrExistingLoan.isExistingLoan === true ? 
                ...
                <Col xl="12" lg="12" sm="12" className="p-0 pr-4">
                    ...
                    <div className="activity-list">
                        <Row className="activity-gray heading-container no-gutters">
                            ...
                            <Col>{themeData.amountToBeRepaid}</Col>
                            <Col>{themeData.amountRepaid}</Col>
                            <Col>{themeData.balanceAmountToRepaid}</Col>
                            <Col>{themeData.reasonForTheDelay}</Col>
                        </Row>
                        {
                            symrExistingLoan.existingLoanList.map((data, index) => (
                                <Row className="custom-select-head no-gutters">
                                    ...
                                    {
                                        symrExistingLoan.existingLoanList.length > 1
                        ...
                        <Row className="text-right">
                            <Col> <Button color="link" onClick={() => props.onAddOrRemoveActivity()}>+ {themeData.addLoan}</Button></Col>
                        </Row>
