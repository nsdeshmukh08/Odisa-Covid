...
export const IEWorkFlow = ({ selectedApplicationStatus = {} }) => {
    return (
        <Fragment>
                            ...
                            <li className="tracker-two pb-2">
                                ...
                                <div className="workflow-list">
                                    <ul className="p-0">
                                        ...
                                        <li className="pb-2">
                                            <p>
                                                <span>GPLF Assessment Date</span>
                                                <a>
                                                    {
                                                        formatDate(
                                                            populateData(
                                                ...
                                                <Fragment>
                                                    ...
                                                    <li >
                                                        ...
                                                        >
                                                            ...
                                                            <a>GPLF Committee Meeting Minutes</a>
