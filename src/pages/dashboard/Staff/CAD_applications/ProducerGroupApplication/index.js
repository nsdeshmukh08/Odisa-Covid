...
class ProducerGroupApplicationClass extends Component {
...
const ProducerGroupApplication = connect(
    mapStateToProps,
    mapDispatchToProps
)(ProducerGroupApplicationClass)

export {ProducerGroupApplication}