...
class IndividualEnterpriseApplicationClass extends Component {
    ...
    render() {
        ...
        let { showDetails, showEdit } = this.state
        showDetails = true;
...
const IndividualEnterpriseApplication = connect(
    mapStateToProps,
    mapDispatchToProps
)(IndividualEnterpriseApplicationClass)

export {IndividualEnterpriseApplication}