...
import { StaffIeList } from 'helpers/tableDataMapper'
import { IE_APPLICATION_TABS } from 'helpers/variables'
...
class UserManagement extends Component {
    ...
    render() {
        ...
        let {  isDetailMode, page,loaders } = this.props;
        // isDetailMode= false;
        const { list, status, sortBy, search, applicationCount,total_pages,selectedApplicationId } = this.state;

        let tableData = !isDetailMode ? StaffIeList.full : StaffIeList.short;
