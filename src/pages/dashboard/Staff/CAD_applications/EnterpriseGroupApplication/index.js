...
class EnterpriseGroupApplicationClass extends Component {
...
const EnterpriseGroupApplication  = connect(
    mapStateToProps,
    mapDispatchToProps
)(EnterpriseGroupApplicationClass)

export {EnterpriseGroupApplication}