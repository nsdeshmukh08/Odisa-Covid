...
class ProducerCollectiveApplicationClass extends Component {
...
const ProducerCollectiveApplication = connect(
    mapStateToProps,
    mapDispatchToProps
)(ProducerCollectiveApplicationClass)

export {ProducerCollectiveApplication}