...
import { beneficiary_community } from 'helpers/tableDataMapper'
import { BenificaryCommunityChart } from 'component/charts/dashboard'

class BenificaryCommunity extends Component {
    ...
    getFilteredTableData = () => {
        ...
        let filteredData = data.location.length > 0 && data.location.filter(data =>
            data.label
                .toLowerCase()
    ...
    render() {
        ...
        let chartListData = beneficiary_community[
            locationType === 3
                ? 'panchayat'
                : locationType === 2
                    ? 'block'
            ...
            <Fragment>
                {
                    locationType <= 2 //CHECKING WHETHER IT IS NOT PANCHAYAT VIEW
                        ? <div className="bg-white position-relative">
                            <BenificaryCommunityChart graphData={data.graphData} />
...
export default BenificaryCommunity;