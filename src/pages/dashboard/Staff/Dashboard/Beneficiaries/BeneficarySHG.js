...
import { beneficiary_SHG } from 'helpers/tableDataMapper'
import { BeneficarySHGChart } from 'component/charts/dashboard'

class BeneficarySHG extends Component {
    ...
    render() {
        ...
        let chartListData = beneficiary_SHG[
            locationType === 3
                ? 'panchayat'
                : locationType === 2
                    ? 'block'
            ...
            <Fragment>
                {locationType <= 2 //CHECKING WHETHER IT IS NOT PANCHAYAT VIEW
                    ? <div className="bg-white position-relative">
                        <BeneficarySHGChart graphData={data.graphData} />
