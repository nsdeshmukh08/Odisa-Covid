...
import { beneficiary_vulnerable } from 'helpers/tableDataMapper'
import { BeneficiaryVulnerableChart } from 'component/charts/dashboard'

class BenificaryVulnerable extends Component {
    ...
    getFilteredTableData = () => {
        ...
        let filteredData = tableData.length > 0 && tableData.filter(data =>
            data.label
                .toLowerCase()
    ...
    render() {
        ...
        let chartListData = beneficiary_vulnerable[
            locationType === 3
                ? 'panchayat'
                : locationType === 2
                    ? 'block'
            ...
            <Fragment>
                {
                    locationType <= 2 //CHECKING WHETHER IT IS NOT PANCHAYAT VIEW
                        ? <div className="bg-white position-relative">
                            <BeneficiaryVulnerableChart graphData={data.graphData} />
...
export default BenificaryVulnerable;