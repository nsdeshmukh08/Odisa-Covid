...
import { fund_TargetAndAchieved } from 'helpers/tableDataMapper'
import FormInput from 'component/inputs/FormInput'
import Pagination from 'component/Pagination/ChartPagination'

class TargetAndAchieved extends Component {
    ...
    render() {
        ...
        let chartListData = fund_TargetAndAchieved[
                                locationType === 3 
                                    ? 'panchayat'
                                    : locationType === 2
                                        ? 'block'
            ...
            <Fragment>
                {
                    locationType <= 2 //CHECKING WHETHER IT IS NOT PANCHAYAT VIEW
                        ? <div className="bg-white position-relative">
                            <ComposedBarChart graphData={data.graphData} locationType={locationType}/>
                            {
...
export default TargetAndAchieved;